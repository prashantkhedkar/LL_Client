...
import { BtnLabelCanceltxtMedium2, BtnLabeltxtMedium2, LabelHeadingSemibold6 } from "../common/formsLabels/detailLabels";
...
export default function ConfirmDialogModal({ setShow, onConfirm, labelMessage }: props) {
