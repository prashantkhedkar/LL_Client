...
export default function AutoCompleteMultiSelectTextBox({ onSearchChangeHandler, data, selectedValue, placeholdertext, isDisabled } : Props) {
            ...
            <div {...getRootProps()}>
                <InputWrapper ref={setAnchorEl} className={focused ? 'focused' : ''}> 
                    {value.map((option: IUsers, index: number) => (
                        <StyledTag label={option.displayName} {...getTagProps({ index })} />
                    ))}                  
