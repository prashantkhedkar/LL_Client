...
export const GRID_DEFAULT_LOCALE_TEXT: GridLocaleText = {
  ...
  noResultsOverlayLabel: 'لا توجد بيانات',
  ...
  toolbarColumnsLabel: 'إختر العمود',

  // Filters toolbar button text
  toolbarFilters: 'التصفية',
  toolbarFiltersLabel: 'أظهر عامل التصفية',
  toolbarFiltersTooltipHide: 'إخفاء عامل التصفية',
  toolbarFiltersTooltipShow: 'إظهار عوامل التصفية',
  toolbarFiltersTooltipActive: (count) =>
    count !== 1 ? `${count} عوامل تصفية` : `${count} عوامل تصفية`,
  ...
  columnMenuFilter: 'التصفية',
  columnMenuHideColumn: 'إخفاء عمود',
  columnMenuUnsort: 'عدم الترتيب',
